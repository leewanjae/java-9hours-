...
public class String2 {
	...
	public static void main(String[] args) {
        ...
        System.out.println(s.substring(7)); // 인덱스 기준 7 부터 시작 (이전 내용은 잘라내기)
        ...
        String s1 = "Java";
        String s2 = "Pyton";
        System.out.println(s1 + s2); // JavaPyton
        System.out.println(s1 + "," + s2); // Java, Pyton
        System.out.println(s1.concat(",").concat(s2)); // Java, Pyton
	}
